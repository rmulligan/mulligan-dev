...
#+HUGO_TAGS: interpretability activation-steering alignment safety
#+HUGO_CATEGORIES: research
...
#+CAPTION: Suppression reversal under hypothetical framing.
[[file:fig17_suppression_reversal_aas.png]]

* Why this matters
If self‑report can be suppressed by training, then evaluations that rely on
self‑report can miss real internal states. That’s a problem for safety.
...
#+CAPTION: Scaling comparison (8B vs 14B).
[[file:fig24_suppression_scaling_comparison.png]]
